	<?php echo $interface->page_heading('Demo of default theme for cakephp asdfasdfasdf');?>
	</div>
	<div class="clear"></div>
	<div class="grid_3">
		<?php echo $interface->open_box('Design Process'); ?>
	...
	<div class="clear"></div>
	<div class="grid_3">
		<?php echo $interface->open_toggle_box('Paragraphs'); ?>
		...
		<div class="box">
			<h2>
				<a href="#" id="toggle-ajax" class="hidden"><img src="<?php echo $html->url('/img/ajax-loader.gif');?>" id="loading" alt="Loading" />
		Ajax Content
	</a>
			</h2>
	...
	Content loaded dynamically
		...
		<?php
		print $interface->open_box('TEST');
		print 'TEST';
		print $interface->close_box();
		?>
		<div class="box menu">
			<h2>
			...
			<div class="block" id="section-menu">
				<?php
				$menu = array(
					$html->link('Menu 1','#',array('class'=>"menuitem")) => array(
							$html->link('Submenu 1','#'),
							$html->link('Submenu 2','#'),
							$html->link('Submenu 3','#',array('class'=>'active')),
							$html->link('Submenu 4','#'),
							$html->link('Submenu 5','#'),
						)
					);
					print $interface->menu($menu);
				?>				
		...
		<div class="box articles">
			...
			<div class="block" id="articles">
				<div class="first article">
					...
					<a href="#" class="image">
						<img src="<?php echo $html->url('/img/photo_60x60.jpg');?>" width="60" height="60" alt="photo" />
					</a>
